## All Random Jobs Available for Level 20 for PC Building Simulator
Makes all the low level random jobs that disappear as you level up in career mode available again up to level 20.

## Install
1. Extract all files in the archive to the main directory of PC Building Simulator
2. Run InstallLevel20AllRandomJobs.cmd
